...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  <head>
    ...
    <?php endif; ?>
    <?php $css_file = drupal_get_path('theme', 'ttctheme') . '/public/css/ttctheme_pdf.css' ?>
    <?php $header_image = drupal_get_path('theme', 'ttctheme') . '/public/images/ttc-logo.png' ?>
    <?php //print $css; ?>
    <link type="text/css" rel="stylesheet" href="/<?php print $css_file; ?>" />
    <style>
      <?php
  ...
  <body>
  <div class="abstract__pdf-header">
 <!--   <img alt="Technology Transfer Center of the National Cancer Institute" class="abstract__pdf-header_image" src="/<?php //print $header_image ?>"> -->
  </div>
    ...
    <div class="print-content abstract__pdf"><?php print $content; ?></div>
    <div class="print-footer abstract__pdf-footer"><?php print theme('print_footer'); ?></div>
