  ...
  $(document).ready(function () {
    ...
    $('a').filter(function () {
      return /^https?\:\/\/([a-zA-Z0-9\-]+\.)+/.test(this.href)
          ...
          && $(this).parents('.follow-us').length === 0; }).after(' <a class="exitNotification" href=' + path + '><img title=' + '"' + altText + '"' + '  alt=' + '"' + altText + '"' + ' src="/sites/all/modules/contrib/extlink/extlink.png" /></a>');
